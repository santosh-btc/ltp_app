...
class NewsArticlesControllerTest < ActionController::TestCase
  ...
  test "should create news_article" do
    assert_difference('NewsArticle.count') do
      post :create, news_article: { article_text: @news_article.article_text, posted_at: @news_article.posted_at, posted_by: @news_article.posted_by, title: @news_article.title }
    end
  ...
  test "should update news_article" do
    patch :update, id: @news_article, news_article: { article_text: @news_article.article_text, posted_at: @news_article.posted_at, posted_by: @news_article.posted_by, title: @news_article.title }
    assert_redirected_to news_article_path(assigns(:news_article))
  end
